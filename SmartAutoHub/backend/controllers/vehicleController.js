...
const { sendTestDriveCancellationEmail } = require('../utils/email');
  ...
  try {
    ...
    if (vehicle.images && vehicle.images.length > 0) {
      try {
        ...
        console.log('✅ Deleted', vehicle.images.length, 'associated images');
      } catch (imageDeleteError) {
        console.error('⚠️  Error deleting images:', imageDeleteError);
